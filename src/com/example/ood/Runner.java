...
public class Runner
{
    public static void main(String[] args)
    {
        ...
        smiths.addChild("Mehroz",32);  // alternative way to add a child - see Family code
        smiths.addChild("Shamick",26);  // alternative way to add a child - see Family code
        ...
        Person person1 = new Person("adsdsa", 65, 1);
        persons.put(person1.getId(),person1);
        System.out.println(persons.get(person1.getId()));
